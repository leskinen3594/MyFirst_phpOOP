...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 05, 2020 at 03:40 PM
...
INSERT INTO `tbmember` (`email`, `password`, `fname`, `lname`, `address`, `mobile`, `memidno`, `verify_code`, `active`) VALUES
('nnada.chr@gmail.com', 'nadanadanada', 'Nada', 'Chemreh', '417 m.1 pakpayoon pakpayoon patthalung', '0123456789', '1909090909099', '', 0),
('teen@gmail.com', '123456789', 'จิรพงศ์', 'สงเนียม', '', '', '', '', 0);
